...
The Coder takes a plan and produces actual code, tests, and
configuration files. It uses MCP tools to read and write files.
"""
...
class CoderAgent(Agent):
    """Agent that implements code from specifications."""
    ...
    async def execute(
        ...
        code_artifacts = self._generate_mock_code(description, plan, step)
        ...
        return AgentResult(
            ...
            output={
                ...
                "spec_id": spec_id,
                "step_id": step_id,
                "files_generated": list(code_artifacts.keys()),
            },
